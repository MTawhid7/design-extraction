...
# --- The 'ModelManager' type hint is now a string to avoid the import ---
def run(input_image: Image.Image, model_manager: "ModelManager") -> Image.Image:
    ...
    # --- STEP 1: PREPROCESS AND RUN IS-NET ---
    ...
    original_alpha = transforms.Resize(original_size[::-1])(pred.unsqueeze(0)).squeeze().cpu().numpy()
    ...
    # --- STEP 6: ADAPTIVE MULTI-TIER MASKING ---
